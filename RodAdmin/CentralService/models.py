...
class Serviço(models.Model) :
    assistencia = models.CharField('Assistência', max_length=100,help_text='Informe Assistência')
    ...
    def __str__(self):
     return f'{self.assistencia}'

class Assistencia(models.Model):
     assistencia = models.CharField('Assistencia', max_length=100)
